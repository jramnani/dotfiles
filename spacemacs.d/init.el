...
before packages are loaded."
  ...
  ;; Git
  ;; Fix bug in that b0rks the ability to edit the list of git rebase todo items.
  ;; Fix by disabling helm-ls-git from the git rebase mode.
  ;; Credit: https://github.com/syl20bnr/spacemacs/issues/15089#issuecomment-984207351
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(helpful sql-indent sqlup-mode emojify emoji-cheat-sheet-plus company-emoji
             vimrc-mode dactyl-mode dokuwiki-mode csv-mode company-terraform
             terraform-mode hcl-mode powershell bmx-mode seeing-is-believing rvm
             ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocopfmt
             rubocop rspec-mode robe rbenv rake minitest enh-ruby-mode chruby
             bundler inf-ruby add-node-modules-path phpunit phpcbf php-extras
             php-auto-yasnippets geben drupal-mode cfrs company-phpactor
             phpactor composer php-runtime company-php ac-php-core xcscope
             php-mode flycheck-elm elm-test-runner elm-mode reformatter systemd
             toml-mode ron-mode racer flycheck-rust dap-mode posframe bui
             treemacs pfuture cargo rust-mode helm-gtags ggtags flycheck-bashate
             counsel-gtags counsel swiper ivy jinja2-mode company-ansible
             ansible-doc ansible yaml-mode tern web-beautify prettier-js
             nodejs-repl livid-mode skewer-mode simple-httpd json-navigator
             hierarchy json-mode json-snatcher json-reformat js2-refactor
             multiple-cursors js2-mode js-doc yapfify sphinx-doc pytest
             pyenv-mode py-isort pippel pipenv pyvenv pip-requirements
             lsp-python-ms lsp-pyright live-py-mode importmagic epc ctable
             concurrent deferred helm-pydoc cython-mode company-anaconda blacken
             anaconda-mode pythonic xterm-color vterm terminal-here shell-pop
             multi-term lsp-ui lsp-treemacs lsp-origami origami helm-lsp
             lsp-mode dash-functional eshell-z eshell-prompt-extras esh-help
             smeargle orgit org-projectile org-category-capture org-present
             org-pomodoro alert log4e gntp org-mime org-download mmm-mode
             markdown-toc markdown-mode magit-gitflow magit-popup htmlize
             helm-gitignore helm-company helm-c-yasnippet gnuplot gitignore-mode
             gitconfig-mode gitattributes-mode git-timemachine git-messenger
             git-link gh-md fuzzy flyspell-correct-helm flyspell-correct
             flycheck-pos-tip pos-tip flycheck evil-magit magit git-commit
             with-editor transient company-statistics company-shell company
             auto-yasnippet yasnippet auto-dictionary ac-ispell auto-complete
             insert-shebang fish-mode ws-butler winum which-key
             volatile-highlights vi-tilde-fringe uuidgen use-package undo-tree
             toc-org spaceline powerline restart-emacs request
             rainbow-delimiters popwin persp-mode pcre2el paradox spinner
             org-plus-contrib org-bullets open-junk-file neotree move-text
             macrostep lorem-ipsum linum-relative link-hint indent-guide hydra
             lv hungry-delete hl-todo highlight-parentheses highlight-numbers
             parent-mode highlight-indentation helm-themes helm-swoop
             helm-projectile projectile pkg-info epl helm-mode-manager helm-make
             helm-flx helm-descbinds helm-ag google-translate golden-ratio
             flx-ido flx fill-column-indicator fancy-battery eyebrowse
             expand-region exec-path-from-shell evil-visualstar
             evil-visual-mark-mode evil-unimpaired f evil-tutor evil-surround
 ...
 '(safe-local-variable-values
   '((ruby-backend quote lsp) (ruby-test-runner quote rspec)
     (ruby-backend quote robe) (setq create-lockfiles)
